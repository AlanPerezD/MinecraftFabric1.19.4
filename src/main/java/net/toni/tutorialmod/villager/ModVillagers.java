package net.toni.tutorialmod.villager;
...
public class ModVillagers {
    ...
    public static final VillagerProfession JUMPY_MASTER = registerProfession("jumpmaster",
    ...
    public static void registerTrades() {
        TradeOfferHelper.registerVillagerOffers(JUMPY_MASTER, 1,
                factories -> {
