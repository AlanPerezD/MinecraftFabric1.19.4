package net.toni.tutorialmod.fluid;
...
public class ModFluids {
    ...
    public static void register() {
        ...
        SOAP_WATER_BLOCK = Registry.register(Registry.BLOCK,
                new Identifier(TutorialMod.MOD_ID,"soap_water_block"), new FluidBlock(ModFluids.STILL_SOAP_WATER, FabricBlockSettings.copyOf(Blocks.WATER)){ });
        SOAP_WATER_BUCKET = Registry.register(Registry.ITEM,
                new Identifier(TutorialMod.MOD_ID,"soap_water_bucket"),
